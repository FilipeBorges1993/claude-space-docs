---
title: "Agent Node"
description: "Main agent configuration including system prompt, model selection, and permissions"
icon: "robot"
---
...
- [Skills Node](/node-types/skills-node) - Add capabilities to your agent
- [Memory Node](/node-types/memory-node) - Give your agent persistent knowledge
- [Sub-agents Node](/node-types/subagents-node) - Delegate to specialist agents
...
[Add Skills →](/node-types/skills-node) | [Add Memory →](/node-types/memory-node) | [Add Sub-agents →](/node-types/subagents-node)
