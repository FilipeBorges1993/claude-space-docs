...
description: "Learn about the 7 node types that make up AI agent systems"
icon: "sitemap"
---
...
|------|---------|-------------|---------------|
| 🤖 **[Agent](/node-types/agent-node)** | Main agent configuration | System prompt, model selection, permissions | Core intelligence |
| 🛠️ **[Skills](/node-types/skills-node)** | Agent capabilities | File operations, API calls, code execution | Tools and actions |
| 🧠 **[Memory](/node-types/memory-node)** | Persistent knowledge | Conversation history, knowledge bases, RAG | Long-term context |
| ⚙️ **[Commands](/node-types/commands-node)** | Custom slash commands | `/summarize`, `/review-pr`, `/deploy` | User shortcuts |
| 🔌 **[MCPs](/node-types/mcps-node)** | External tool integrations | Context7 docs, databases, APIs | System connections |
| 🪝 **[Hooks](/node-types/hooks-node)** | Lifecycle event handlers | PreToolUse, PostToolUse, SessionStart | Event triggers |
| 🎭 **[Sub-agents](/node-types/subagents-node)** | Delegated specialized agents | Code reviewer, researcher, writer | Agent delegation |
...
[Learn more →](/node-types/agent-node)
...
[Learn more →](/node-types/skills-node)
...
[Learn more →](/node-types/memory-node)
...
[Learn more →](/node-types/commands-node)
...
[Learn more →](/node-types/mcps-node)
...
[Learn more →](/node-types/hooks-node)
...
[Learn more →](/node-types/subagents-node)
...
- [🤖 Agent Node](/node-types/agent-node) - Configure main agent (system prompt, model, permissions)
- [🛠️ Skills Node](/node-types/skills-node) - Add custom capabilities and tools
- [🧠 Memory Node](/node-types/memory-node) - Persistent knowledge and context
- [⚙️ Commands Node](/node-types/commands-node) - Create slash commands
- [🔌 MCPs Node](/node-types/mcps-node) - External integrations
- [🪝 Hooks Node](/node-types/hooks-node) - Lifecycle event handlers
