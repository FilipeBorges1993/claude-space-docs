---
title: "Memory Node"
description: "Enable persistent knowledge with conversation history and knowledge bases"
icon: "brain"
---
...
[← Skills Node](/node-types/skills-node) | [Agent Node](/node-types/agent-node) | [Commands Node →](/node-types/commands-node)
