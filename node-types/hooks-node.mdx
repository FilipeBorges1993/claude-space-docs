---
title: "Hooks Node"
description: "Handle lifecycle events with PreToolUse, PostToolUse, and SessionStart hooks"
icon: "fish-fins"
---
...
[← MCPs Node](/node-types/mcps-node) | [Agent Node](/node-types/agent-node) | [Sub-agents Node →](/node-types/subagents-node)
