...
**Structure:**
```
[Agent 1: Collect] → [Agent 2: Process] → [Agent 3: Report]
```
...
- [Testing Agents](../06-testing-agents.md) - Test multi-agent systems
- [Exporting Agents](../07-exporting-agents.md) - Deploy sub-agents
- [Canvas Workflow](../05-canvas-workflow.md) - Build complex graphs

---

<div align="center">

[← Hooks Node](hooks-node.md) | [Agent Node](agent-node.md) | [Back to Node Types](README.md)
